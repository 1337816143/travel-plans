...
// v1.0.15 predates the later manifest convention. Validate the rollback files that
// actually exist instead of requiring a manifest that was never part of that release.
const stableV1Files = [
  'src/v1.0.15.html',
...
for (const file of stableV1Files) {
...
const report = {
  ...
  stableFallbackVersion: '1.0.15',
  stableFallbackFiles: stableV1Files.length,
};
