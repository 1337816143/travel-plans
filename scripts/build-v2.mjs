...
await import('./migrate-v2.4.mjs');
await import('./migrate-v2.4-features.mjs');
...
let html=read('src-v2','template.html').replace('正在初始化旅行工具……','点击“旅行工具”后按需加载日历、打印、数据管理和风险计算。');
const css=[
...
const initialBudget=Math.floor(Number(previousManifest.gzipBytes)*0.98);
const totalBudget=Number(previousManifest.gzipBytes)+22000;
