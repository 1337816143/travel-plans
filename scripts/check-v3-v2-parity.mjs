...
console.log(
  `v2.5.4 rollback → v2.5.7/v3 parity passed: frozen HTML ${stableSha256}, 49 legacy points, 8 days, 9 beach rows, shared rain workspace and native Leaflet planner map`,
);
