...
本 Draft PR 已在旁路完成 Planner、Phase 3 编辑器和 Phase 4 内容候选工程闭环，但没有把候选数据伪装成人工审核后的正式攻略，也没有完成全部 Legacy 内容无损迁移。项目仍不生成正式图标资产、不选定小程序框架、不修改高德凭据、不改 Service Worker、不切换 Pages、不删除 v2.5.4／v1.0.15，也不自动合并。当前路线和住宿时间仍是明确标记的直线降级估算；正式 Provider 网关、人工内容审批、Legacy 功能逐项迁移和小程序 PoC 必须继续按 Phase 4–6 门禁推进。详见 `phase4-content-gap-report.md`。
