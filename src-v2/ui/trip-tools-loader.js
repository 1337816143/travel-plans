/* v2.5.4 lazy loader for organized travel operations, complete wishlist and data tools. First load must render and group populated controls before reporting readiness. */
(function(){
  'use strict';
  let promise=null,loaded=false;
  function assetUrl(){const root=location.pathname.includes('/versions/')?'../':'';return root+'assets/v2.5.4/lazy-tools.js?loader=2.5.4'}
