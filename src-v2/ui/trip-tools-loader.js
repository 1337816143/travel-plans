...
(function(){
  ...
  function initialize(){window.TravelTripOperations?.init?.();window.TravelTripOperations?.renderAll?.();window.TravelCalendarExport?.mount?.();window.TravelLocalData?.render?.();loaded=true;document.documentElement.dataset.tripToolsLoaded='true';document.dispatchEvent(new CustomEvent('travel:tools-loaded'));return true}
